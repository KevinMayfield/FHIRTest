package uk.nhs.digital.CareConnect.ServerDemostrator.config;
...
jdbc.url=jdbc:sqlserver://localhost:1433;databaseName=PPMPLUS
...
jdbc.url=jdbc:mysql://localhost:3306/PPMPLUS
jdbc.username=fhirjpa
jdbc.password=fhirjpa
 ...
 */
	...
	public class FhirServerConfigDstu2  {
		...
		public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
			...
			retVal.setPackagesToScan("uk.nhs.leedsth.fhir.entity");
