package uk.nhs.digital.CareConnect.ServerDemonstrator.provider;
...
import uk.nhs.leedsth.fhir.dao.PatientDAO;
...
public class PatientResourceProvider extends BaseProvider implements IResourceProvider {
	...
	private static final Logger log = LoggerFactory.getLogger(uk.nhs.digital.CareConnect.ServerDemonstrator.provider.PatientResourceProvider.class);
	...
	public MethodOutcome createPatient(HttpServletRequest theRequest,@ResourceParam Patient thePatient) {
		...
		try 
		{
			...
			log.info("Return the New Patient id = "+theNewPatient.getId());
