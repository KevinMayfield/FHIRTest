...
public class GATicket extends java.lang.Object {
  ...
  public static void main(java.lang.String[] args) {
    GATicket ticket = null;
    try {
      GATicket.debugOut("TEST - MAIN: Starting.");
      ticket = new GATicket();
      ticket.setIsDebug(true);
      String ticketStr = ticket.getTicket();
      GATicket.debugOut("TEST - MAIN: GATicket -> " + ticketStr);
    }
    catch (Throwable err) {
      err.printStackTrace();
      if (null!=ticket)
        GATicket.debugOut("error code: " + ticket.getLastError());
    }
  }
}